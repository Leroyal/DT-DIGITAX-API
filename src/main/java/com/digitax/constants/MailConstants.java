...
public class MailConstants {
	public static final String fromEmial = "support@digitaltaxusa.com";
	public static final String emailSubject = "Digitax";
	public static final String baseUrl = "http://digitaltaxusa.com/";
